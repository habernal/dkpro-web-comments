 ...
 */
public class ProConOrgCommentsParserTest
{
    @Test
            ...
            throws Exception
    {
        InputStream stream = this.getClass().getClassLoader()
                .getResourceAsStream("view.answers.reader-comments-vegetarian.html");

        DebateParser parser = new ProConOrgCommentsParser();
