...
public class NYTimesArticleExtractor {
	...
	public Article extractArticle(String html) throws ParseException {
		...
		// debate description
		result.setDebateDescription(Utils.normalize(((TextNode) doc.select("div.nytint-discussion-overview > p").iterator().next().childNodes().iterator().next()).text()));
